...
require_once SEOHC_DIR . 'includes/class-seohc-schedule.php';
require_once SEOHC_DIR . 'includes/class-seohc-mailer.php';
require_once SEOHC_DIR . 'includes/class-seohc-forms.php';
require_once SEOHC_DIR . 'includes/class-seohc-launch-checks.php';
require_once SEOHC_DIR . 'includes/class-seohc-updater.php';
